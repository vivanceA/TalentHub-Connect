...
<style>
    ...
    <div class="container">
        ...
        <div class="sidenav">
            ...
            <img src="images/logo.jpg" alt="Logo" style="height: 50px; margin-bottom:20px; margin-top:10px;">
                ...
                <a class="active" href="c"><i class="fas fa-home"></i> Overview</a>
                <li><a href="Explore_talents.php"><i class="fa fa-search"></i> Explore talents</a></li>
                <li><a href="employee_dashboard.php"><i class="fas fa-user"></i> Hired talents</a></li>
    ...
    <div class="dashboard">
        ...
        <div class = "welcome">
            ...
            <p>We appreciate trusting us with your needs!</p>
        </div>

        <div class="intro">
            <img src="images/employees.jpeg" alt="Employees" width="40%" style="border-radius:50px; margin-bottom: 100 px;">
            <h1>Ready to Hire?</h1>
            <p>Find talents with Talent Hub. Look through our list of talented individuals ready for hire!</p>
      ...
      <div class="hiring-status">
        <h2><a href="Explore_talents.php">Employee Hiring Status</a></h2>
        <table>
          <thead>
            <tr>
              <th>Personnel</th>
        ...
        <br>
        <a href="Explore_talents.php" style="color:blue"><u>View More</u></a>
      </div>
    </div>
  </div>
</body>
